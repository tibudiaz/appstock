...
const HomeScreen = ({ navigation }) => {
  ...
  if (loggedIn) {
    // Redireccionar a otra pantalla una vez autenticado
    navigation.navigate('LoggedInScreen'); // Asegúrate de tener una pantalla con este nombre en tu stack de navegación
  }
